...
public class ShirtDetails {
	...
	private String shirtHandLoose;
	private String shirtHeight;
	private String shirtLoose;
	private String shirtOther;
	private String shirtPress;
	private String shirtQuantity;
	private float shirtRate;
	private String shirtShape;
	private String shirtShoulder;
	private String shirtSleeve;
	...
	public String toString() {
		return "ShirtDetails [ shirtChest=" + shirtChest + ", shirtCollar=" + shirtCollar
				+ ", shirtHandLoose=" + shirtHandLoose + ", shirtHeight=" + shirtHeight + ", shirtLoose=" + shirtLoose
				+ ", shirtOther=" + shirtOther + ", shirtPress=" + shirtPress + ", shirtQuantity=" + shirtQuantity
				+ ", shirtRate=" + shirtRate + ", shirtShape=" + shirtShape + ", shirtShoulder=" + shirtShoulder
				+ ", shirtSleeve=" + shirtSleeve + ", shirtSleeveCup=" + shirtSleeveCup + ", shirtStomach="
